...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <center>   <h4 class="t-service"><img src="asset/img/setting.png" height="30" alt=""> Thống Kê Website</h4></center>
        <p></p>
          ...
          <div class="col-lg-4 col-6">
				...
				<div class="col-lg-4 col-6">
					<a rel="nofollow" href="/setup-payment">
						<div class="card card-service box-service-panel">
						    <div class="card-body" data-toggle="tooltip" data-placement="bottom" title="Trao đổi cảm xúc bài viết để kiếm tiền.">
						        <div class="box-body text-center">
			    ...
			    <div class="col-lg-4 col-6">
					<a rel="nofollow" href="/setup-product">
						<div class="card card-service box-service-panel">
						    <div class="card-body" data-toggle="tooltip" data-placement="bottom" title="Trao đổi bình luận bài viết để kiếm tiền.">
						        <div class="box-body text-center">
			    ...
			    <div class="col-lg-4 col-6">
					<a rel="nofollow" href="/add-product">
						<div class="card card-service box-service-panel">
						    <div class="card-body" data-toggle="tooltip" data-placement="bottom" title="Trao đổi chia sẻ bài viết để kiếm tiền.">
						        <div class="box-body text-center">
