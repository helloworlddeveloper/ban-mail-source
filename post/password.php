...
mysqli_query($conn,"UPDATE users SET `password` = '".mysqli_real_escape_string($conn,$password)."',`repassword` = '".mysqli_real_escape_string($conn,$password)."'  WHERE `username`='$username'");
